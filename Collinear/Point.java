...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        Point point2 = new Point(12000, 15000);
        Point point3 = new Point(12000, 20000);
        ...
        Comparator<Point> compares = point1.slopeOrder();
        System.out.println(compares.compare(point2, point3));
